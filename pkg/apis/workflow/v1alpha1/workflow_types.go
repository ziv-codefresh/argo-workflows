...
type SemaphoreRef struct {
	...
	// Selectors is an array of the relevant filters
	Selectors []string `json:"selector,omitempty" protobuf:"bytes,2,opt,name=selectors"`
	// we need to add here or in ConfigMapKeySelector type a new filters field or selectors for
}
